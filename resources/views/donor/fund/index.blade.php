    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-500 mt-2">
                Your contribution supports future emergency and community initiatives.
            </p>
        ...
        <div class="bg-white border rounded-3xl p-8 mb-8">
            ...
            <p class="text-gray-500 mt-4">
                This fund is reserved for future emergencies, disaster relief,
                welfare assistance and community development programs.
            </p>
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="bg-white border rounded-3xl p-6">
                ...
                <a href="/donor/payment-gateway" class="block">
